...
# 文件路径
input_file = 'news_category_13.txt'
output_file = 'news_13_Jap_LLM.txt'
...
def translate_text(text):
    try:
        response = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system", "content": "你是一个专业的新闻翻译员，请将以下新闻标题准确翻译成日文，保持标题的简洁性和新闻性，不要添加任何额外解释，如果新闻本就是日文，请直接返回原始文本，不要做任何解释。"},
